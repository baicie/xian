...
const task=(id:string,column:string,kind:Task['kind']='TASK'):Task=>({id,number:1,projectId:'project',title:id,description:'',kind,column,priority:'中',assignee:'未分配',assigneeId:'',due:'',tags:[],version:1})
