...
export const api={
  ...
  setTaskWatch(workspaceId:string,taskId:string,watching:boolean){return request<{watching:boolean}>(`/workspaces/${workspaceId}/tasks/${taskId}/watch`,{method:'PUT',body:JSON.stringify({watching})})},
