...
export const snapshotSchema=z.object({schemaVersion:z.union([z.literal(1),z.literal(2),z.literal(3)]),workspace:z.object({name:z.string()}),members:z.array(member),projects:z.array(project),documents:z.array(document),plans:z.array(plan),assets:z.array(asset).default([])})
